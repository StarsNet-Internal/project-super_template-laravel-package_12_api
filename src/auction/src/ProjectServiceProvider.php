...
namespace Starsnet\Project\Auction;

use Illuminate\Support\ServiceProvider;

// Import the controller here directly
// use StarsNet\Project\Auction\App\Http\Controllers\Customer\FakerController;
...
{
    protected $namespace = 'StarsNet\Project\Auction\App\Http\Controllers';

    protected $routePrefix = 'auction';
