...
class ReferralCodeController extends Controller
{
    private function getReferralCodeInfo($customerIDs, ?string $storeID = null): Collection
    {
        ...
        foreach ($customers as $customer) {
            ...
            if (!is_null($customerRequest) && $customerRequest->reply_status === ReplyStatus::APPROVED->value) {
    ...
    public function getReferralCodeDetails(Request $request): array
    {
        ...
        $referralCode = ReferralCode::where('customer_id', $customer->id)->latest()->first();
