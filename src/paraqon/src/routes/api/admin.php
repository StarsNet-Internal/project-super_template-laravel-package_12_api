...
Route::group(
    ['prefix' => 'seeder'],
    function () {
        Route::get('/health-check', [SeederController::class, 'healthCheck']);
        Route::get('/from-store-to-orders', [SeederController::class, 'fromStoreToOrders']);
        Route::get('/stores/{store_id}/generate-orders', [SeederController::class, 'generateAuctionOrders']);
    }
);
