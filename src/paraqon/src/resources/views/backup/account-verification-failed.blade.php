{{-- Account Verification Failed / Order Cancelled Email Template --}}

@php
$uniqueId = 'email_failed_' . uniqid();
...
<div class="{{ $uniqueId }}">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
        <tbody>
            <tr>
                <td class="o_bg-white o_px-md o_py-xl" align="center"
                    ...
                    <div class="o_col-6s o_sans o_text-md o_text-light o_center"
                            ...
                            <tbody>
                                <tr>
                                    <td class="o_sans o_text o_text-secondary o_b-primary o_px o_py o_br-max" align="center"
                                        ...
                                        <img src="https://starsnet-development.oss-cn-hongkong.aliyuncs.com/png/625ac2e1-1562-4e59-8b3c-9c4fb8808b13.png"
                        ...
                        <h2 class="o_heading o_text-dark o_mb-xxs"
                            style="font-family: Helvetica, Arial, sans-serif; font-weight: bold; margin-top: 0; margin-bottom: 4px; font-size: 30px; line-height: 39px; color: {{ $primaryColor }};">
                            {{ $data['title'] }}
                        </h2>
