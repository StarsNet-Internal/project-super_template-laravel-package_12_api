...
class AuctionController extends Controller
{
    public function syncCategoriesToProduct(Request $request): array
    {
        ...
        $existingAssignedCategories = ProductCategory::whereIn('id', $product->category_ids)->get();
        ...
        $newCategories = ProductCategory::whereIn('id', (array) $request->ids)->get();
    ...
    public function getAllRegisteredUsers(Request $request): Collection
    {
        ...
        return Customer::whereIn('id', $registeredCustomers->keys())
            ->with(['account.user'])
            ->get()
    ...
    public function returnAuctionLotToOriginalCustomer(Request $request): array
    {
        ...
        Product::whereIn('id', $productIDs)->update(['listing_status' => 'AVAILABLE']);
